...
- Se generan tablas auxiliares en Power Query para calculo de recency y evaluación de estados y score para ambos períodos de corte y se únifican en una nueva tabla.
